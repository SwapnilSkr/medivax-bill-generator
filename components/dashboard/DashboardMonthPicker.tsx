...
export function DashboardDateFilterBar({
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-2">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:items-end lg:max-w-xl">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className="h-9 w-full justify-between gap-2 px-3 font-normal min-w-0"
              >
      ...
      <p className="text-[0.7rem] leading-snug text-muted-foreground sm:max-w-xl">
        {hint}
      </p>
    </div>
  );
